...
\1_started_at = datetime.datetime.now().isoformat()
\1_proc = subprocess.Popen(command_tts, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
\1_track_process("tts", _proc.pid)
\1_stdout, _stderr = _proc.communicate()
